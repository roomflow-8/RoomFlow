...
//public class ReservationRestController_BU {
//
...
//
//        EquipmentReservationRes result = reservationService.addEquipmentsToReservation( user.getUserId(),  reservationId, request);
//
//        return ApiResponse.success(
...
//            @AuthenticationPrincipal CustomUser user, @PathVariable Long reservationId, @RequestBody @Valid ConfirmReservationReq request) {
//        log.info("비품 예약 확정 요청 - reservationId: {}, equipmentIds: {}",
//                reservationId, request.reservationEquipmentIds());
//
//        reservationService.confirmEquipmentsService( user.getUserId(),  reservationId, request.reservationEquipmentIds());
//
...
//                reservationId, request.reservationEquipmentIds());
//
//        reservationService.cancelReservationEquipments( user.getUserId(),reservationId, request);
//
